...
var index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await import("./layout-6AE3GQ5B.js");
        return {
          Component: Layout
        };
      },
    ...
    app.widgets.register([
      {
        ...
        component: async () => {
          const { ChartEntriesWidget } = await import("./Widgets-YFZEFKZC.js");
      ...
      },
      {
        ...
        component: async () => {
          const { LastEditedWidget } = await import("./Widgets-YFZEFKZC.js");
      ...
      },
      {
        ...
        component: async () => {
          const { LastPublishedWidget } = await import("./Widgets-YFZEFKZC.js");
...
//# sourceMappingURL=chunk-PQSCWPKY.js.map
